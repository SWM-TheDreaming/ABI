    ...
    client.web3.eth.getTransactionCount(process.env.SEND_ACCOUNT, (err, txCount) => {
      ...
      client.web3.eth.sendSignedTransaction(raw)
        ...
        .once('receipt', async (receipt) => {
          ...
          await conn.execute('INSERT INTO contracts VALUES (?,?,?,?,?,?,?)', [null, hashedGroupInfo.crypt, contractWriteResult.contractAddress, contractTitle,hashedGroupInfo.salt ,nowTime, nowTime]);
          await conn.execute('INSERT INTO contract_log VALUES (?,?,?,?)', [null, hashedGroupInfo.crypt, contractWriteResult.transactionHash, nowTime]);
